...
parser.add_argument('--data-dir', default="data/base/programs",type=str, required=True)
parser.add_argument('--model-dir',default="experiments/kmeans/base/programs/best_model", type=str, required=True)
